								...
								<div transition:slide={{ duration: 250, easing: cubicOut }} class="mt-2.5 pt-2.5 border-t border-zinc-100/80 space-y-2">
									...
									<div class="pt-2 flex gap-2">
										<a
											...
											target="_blank"
											rel="noopener noreferrer"
											class="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-blue-50/50 hover:bg-blue-100 border border-blue-200/60 py-2 text-[11px] font-bold text-blue-700 transition-all shadow-sm active:scale-95"
										>
											Proceed to Trade ↗
										</a>
										{#if $p2pOrderStore.marketRate}
