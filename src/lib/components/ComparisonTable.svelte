	...
	<table class="min-w-full text-left text-sm whitespace-nowrap">
		<thead class="bg-zinc-50/30 border-b border-zinc-200/60">
			<tr class="text-[11px] font-bold uppercase tracking-widest text-zinc-500">
				<th scope="col" class="px-4 py-4 md:px-8 md:py-6">Exchange & Merchant</th>
				<th scope="col" class="px-4 py-4 md:px-8 md:py-6">Price</th>
				<th scope="col" class="px-4 py-4 md:px-8 md:py-6">Available</th>
				<th scope="col" class="px-4 py-4 md:px-8 md:py-6">Limits</th>
				<th scope="col" class="px-4 py-4 md:px-8 md:py-6">Payment Methods</th>
				<th scope="col" class="px-4 py-4 md:px-8 md:py-6 text-right">Action</th>
			</tr>
		</thead>
		<tbody class="divide-y divide-zinc-100">
			{#if isLoading}
				<tr>
					<td colspan="6" class="px-4 py-16 md:px-8 md:py-20 text-center">
			...
			{:else if orders.length === 0}
				<tr>
					<td colspan="6" class="px-4 py-16 md:px-8 md:py-20 text-center text-zinc-500 font-medium">
					...
					<tr class="transition-all duration-300 ease-out hover:bg-white/50 hover:backdrop-blur-xl group cursor-default">
						...
						<td class="px-4 py-3 md:px-8 md:py-5 text-right">
							<a
								...
								target="_blank"
								rel="noreferrer"
								class="inline-flex items-center justify-center rounded-full bg-blue-600 px-4 py-2 md:px-6 md:py-2.5 text-xs font-bold text-white shadow-md shadow-blue-600/20 transition-all duration-300 ease-out hover:bg-blue-700 hover:shadow-lg active:scale-95 whitespace-nowrap"
							>
								Trade ↗
							</a>
						</td>
